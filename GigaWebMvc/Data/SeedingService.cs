...
namespace GigaWebMvc.Data
{
    ...
    {
        private GigaWebMvcContext _context;

        public SeedingService(GigaWebMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            SalesRecord r1 = new SalesRecord(new int(), new DateTime(2018, 9, 25), 11000.0, SaleStatus.Billed, s1);
